...
local errors = {
    ...
    -- 权限集常见排错指南
    -- https://developers.weixin.qq.com/doc/oplatform/Third-party_Platforms/2.0/troubleshooting/third_party_authority_instructions_troubleshooting.html
    { 48001,    [[api 功能未授权，请确认公众号/小程序已获得该接口权限]]},
    { 61007,    [[api 功能未授权，请确认公众号/小程序已将对应的权限集授权给第三方平台]] },
    ...
    {48001,  [[api unauthorized]],  [[api功能未授权，请确认公众号已获得该接口，可以在公众平台官网 - 开发者中心页中查看接口权限]]},
    ...
    {61014,  [[must use component token for component api]] },
    ...
    {65306,  [[conditional menu not support]],  [[不支持个性化菜单的帐号]]},
    ...
    {89000,  [[account has bound open]],  [[account has bound open，该公众号/小程序已经绑定了开放平台帐号]]},
    {89001,  [[not same contractor]],  [[not same contractor，Authorizer 与开放平台帐号主体不相同]]},
    {89002,  [[open not exists]],  [[open not exists，该公众号/小程序未绑定微信开放平台帐号。]]},
    {89003,  [[open is not created by api]],  [[该开放平台帐号并非通过 api 创建，不允许操作]]},
    ...
    {89258,  [[code is gray online]],  [[当前小程序帐号存在灰度发布中的版本，不可操作快速更新]]},
    ...
    {91001,  [[not fast register]],  [[不是公众号快速创建的小程序]]},
